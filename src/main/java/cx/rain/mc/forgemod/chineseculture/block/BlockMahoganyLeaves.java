...
@ModBlock(name = "mahogany_leaves",translate = "mahoganyLeaves")
public class BlockMahoganyLeaves extends BlockLeaves {
    ...
    public Item getItemDropped(IBlockState state, Random random, int fortune) {
        return Item.getItemFromBlock(RegistryBlocks.BLOCKS.get("mahogany_sapling"));
    }
